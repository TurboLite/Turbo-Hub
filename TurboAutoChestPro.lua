...
createTextLabel("Auto Farm Chest", Color3.fromRGB(255, 0, 0), UDim2.new(0.25, 0, 0.3, 0))
createTextLabel("Tạo Bởi: Turbo Lite", Color3.fromRGB(0, 255, 0), UDim2.new(0.25, 0, 0.3, 0))
