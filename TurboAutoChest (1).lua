...
createTextLabel("Auto Chest", Color3.fromRGB(0, 255, 255), UDim2.new(0.25, 0, 0.3, 0))
createTextLabel("Tạo Bởi: Turbo Lite", Color3.fromRGB(255, 255, 0), UDim2.new(0.25, 0, 0.3, 0))

repeat wait()
until game:IsLoaded()
local TableChat = {"YouTube: Turbo Lite","Turbo Lite On Top"}
spawn(function()
    while wait() do 
        pcall(function()
