...
createTextLabel("Đừng Treo Script Xuyên Đêm", Color3.fromRGB(0, 255, 0), UDim2.new(0.25, 0, 0.3, 0)
createTextLabel("Để Trách Bị Reset Beli", Color3.fromRGB(0, 255, 0), UDim2.new(0.25, 0, 0.3, 0)
